...
exports.handler = async (event) => {
  ...
  try {
    await transporter.sendMail({
      ...
      subject: `📩 [${ticketId}] New Contact Submission from ${name}`,
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: `✅ Ticket ${ticketId} received — Nikagenyx`,
      html: `
        <div style="font-family: 'Segoe UI', sans-serif; background: #f9fafb; padding: 30px;">
          <div style="max-width: 600px; margin: auto; background: white; padding: 24px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
            ...
            <p>Thank you for contacting <strong>Nikagenyx Vision Tech Private Limited</strong>.</p>
            <p>We've received your message. Your ticket reference ID is <strong>${ticketId}</strong>.</p>
            ...
            <p>If you have any urgent queries, reply to this email quoting your ticket ID.</p>
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ success: true, message: "Emails sent successfully.", ticketId })
    };
