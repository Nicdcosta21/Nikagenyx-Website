...
const AccountsLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Invoicing', path: '/accounts/invoicing' },
    { name: 'GST/TDS Filing', path: '/accounts/tax' },
    { name: 'Reports', path: '/accounts/reports' },
    { name: 'Audit Logs', path: '/accounts/audit' },
  ];
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <Link to="/" className="text-xl font-bold text-indigo-600">Nikagenyx</Link>
              </div>
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              <div className="ml-3 relative">
                <div>
                  <button className="bg-indigo-600 p-1 px-3 rounded-md text-white text-sm">
                    {user?.name || 'User'}
                  </button>
                </div>
              </div>
